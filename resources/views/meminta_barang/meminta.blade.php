        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflowhidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray100">
                    <!-- CONTENT HERE -->
                    <form method="post" action="{{ route('permintaan_barang.kirim_permintaan') }}" enctype="multipart/form-data"
                        ...
                        <div class="max-w-xl">
                            <x-input-label for="jml_barang_permintaan" value="Jumlah Barang Permintaan" />
                            <x-text-input id="jml_barang_permintaan" type="number" name="jml_barang_permintaan" class="mt-1 block w-full"
                                value="{{ old('jml_barang_permintaan')}}" required />
                            <x-input-error class="mt-2" :messages="$errors->get('jml_barang_permintaan')" />
                        </div>
